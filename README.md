...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/conda-mirror-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-mirror-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `conda-mirror` available on your platform:
...
```
pixi search conda-mirror --channel conda-forge
```
